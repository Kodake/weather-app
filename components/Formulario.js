...
const Formulario = ({ busqueda, setBusqueda, setConsultar }) => {
  ...
  return (
    <>
      <View>
        <View>
          <TextInput value={ciudad} style={styles.input} onChangeText={ciudad => setBusqueda({ ...busqueda, ciudad })} placeholder="Ciudad" placeholderTextColor="#666"
          />
        </View>
        <View>
          <Picker selectedValue={pais} style={styles.selector} onValueChange={pais => setBusqueda({ ...busqueda, pais })}>
